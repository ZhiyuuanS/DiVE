...
def main():
  ...
  env = crafter.Recorder(env, f'./new_trajectory/seed_{args.seed}')
  env.reset()
  achievements = set()
  duration = 0
  return_ = 0
  ...
  while running:
    ...
    print('available_actions: ', env._player._available_action(""))
    print('Player:', env._player.pos)
    print('Diamonds:', env._world.location('diamond'))
    # Achievements.
    unlocked = {
